...
class EmailService {
  ...
  // 🔥 NUEVO MÉTODO: Enviar email con contraseña temporal
  async sendTemporaryPassword(email, name, tempPassword) {
    try {
      ...
      const mailOptions = {
        from: {
          name: 'Mi Ciudad SV - Recuperación',
          address: process.env.EMAIL_USER
        },
        to: email,
        subject: '🔑 Nueva Contraseña Temporal - Mi Ciudad SV',
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
              <h1 style="color: white; margin: 0; font-size: 28px;">🏙️ Mi Ciudad SV</h1>
            ...
            <div style="background: white; padding: 40px; border-radius: 0 0 10px 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
              ...
              <p style="color: #666; font-size: 16px; line-height: 1.6;">
                Has solicitado recuperar tu contraseña en <strong>Mi Ciudad SV</strong>. 
                Aquí tienes tu nueva contraseña temporal:
              </p>
              
              <div style="background: #f8f9fa; padding: 30px; border-radius: 10px; text-align: center; margin: 30px 0;">
                <div style="font-size: 14px; color: #666; margin-bottom: 10px;">Tu contraseña temporal es:</div>
                <div style="font-size: 24px; font-weight: bold; color: #667eea; letter-spacing: 4px; font-family: 'Courier New', monospace; background: #fff; padding: 15px; border-radius: 8px; border: 2px dashed #667eea;">
                  ${tempPassword}
                </div>
              </div>
              ...
              <div style="background: #fff3cd; border: 1px solid #ffeaa7; border-radius: 8px; padding: 16px; margin: 20px 0;">
                <p style="color: #856404; font-size: 14px; margin: 0; text-align: center;">
                  <strong>⚠️ IMPORTANTE:</strong> Por seguridad, cambia esta contraseña temporal 
                  por una nueva contraseña personal después de iniciar sesión.
                </p>
              </div>
              
              <p style="color: #666; font-size: 14px;">
                Si no solicitaste esta recuperación, contacta inmediatamente al soporte técnico.
              </p>
      ...
      console.log('❌ Error sending temporary password email:', error.message);
      throw error;
    }
  }
}
